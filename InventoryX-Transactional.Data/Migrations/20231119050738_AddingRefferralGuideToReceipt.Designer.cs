...
namespace InventoryX_Transactional.Data.Migrations
{
    ...
    [Migration("20231119050738_AddingRefferralGuideToReceipt")]
    partial class AddingRefferralGuideToReceipt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryX_Transactional.Data.Models.Client", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 0, 7, 38, 746, DateTimeKind.Local).AddTicks(1603));
            ...
            modelBuilder.Entity("InventoryX_Transactional.Data.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 0, 7, 38, 746, DateTimeKind.Local).AddTicks(4293));
            ...
            modelBuilder.Entity("InventoryX_Transactional.Data.Models.ProductPrice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 0, 7, 38, 746, DateTimeKind.Local).AddTicks(5051));
            ...
            modelBuilder.Entity("InventoryX_Transactional.Data.Models.Provider", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 0, 7, 38, 746, DateTimeKind.Local).AddTicks(2133));
            ...
            modelBuilder.Entity("InventoryX_Transactional.Data.Models.Receipt", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 0, 7, 38, 746, DateTimeKind.Local).AddTicks(5436));
            ...
            modelBuilder.Entity("InventoryX_Transactional.Data.Models.ReceiptProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 0, 7, 38, 746, DateTimeKind.Local).AddTicks(7195));
            ...
            modelBuilder.Entity("InventoryX_Transactional.Data.Models.Warehouse", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 0, 7, 38, 746, DateTimeKind.Local).AddTicks(2640));
